...
'mail_msg_ticket_lock'=>'ЗАЯВКА ПРИНЯТА В РАБОТУ',
...
't_LIST_subj'=>'Тип работ',
// <? = lang ('t_LIST_prio');
't_LIST_worker'=>'Автор',
't_LIST_placer'=>'Зона',
't_LIST_txtmg'=>'Заявка',
't_LIST_compl'=>'Выполнено',
't_LIST_zatr'=>'Затрачено',
't_LIST_commen'=>'Комментарий',
't_LIST_ispo'=>'Исполнитель',
't_LIST_create'=>'Создан',
't_LIST_ago'=>'Прошло',
't_LIST_init'=>'Автор',
't_LIST_to'=>'Исполнитель',
't_LIST_status'=>'Статус',
't_LIST_deadline'=>'Крайний срок',
...
'TICKET_t_a_e_subj'=>'в заявке был изменен тип работ',
...
'HELP_new_text' => '<p>Для создания заявки, Вам необходимо заполнить обязательные поля.
                                ...
                                <ol>
                                    ...
                                    <li><strong>Тип работ</strong> - указывается кратко тип работ.</li>
...
'ticket_sort_personal' => 'Назначенные мне',
'with_long_term' => 'С долгосрочными',
'without_long_term' => 'Без долгосрочных',
'tasks_24_hours' => 'Задачи за 24 часа',
        'results' => 'Результатов',
        'Events_report' => 'Отчет по событиям',
            );

...
//require_once ('/home/admin/web/alex.example.com/public_html/app/classes/classes.php');
...
deadline_time_high_prio=:deadline_time_high_prio
  where uniq_id=:el_id');
        ...
        (user_init_id, user_to_id, date_create, subj, sabj_pl, msg, client_id, unit_id, period, period_arr, action_time, dt_start, dt_stop, prio) values (
        :user_init_id, 
        :user_to_id, 
        :date_create, 
        :subj,
    ...
    <?php
        ...
        <center>
            ...
            try {
                ...
                $sheet->setTitle('отчет 1');
            } catch (Exception $e) {
                echo $e->getMessage();
            }
            $sheet->setCellValue('A1',lang('STATS_by_unit').' '.$start.' - '.$end.' '.get_unit_name($unit));
...
<div class="box-body">
    <center>
        <h4>
        <?php
            $sheet->setCellValue('A2',lang('STAT_MAIN_t1'));
            $sheet->mergeCells('A2:H2');

            echo lang('STAT_MAIN_t1');
        ?>
        </h4>
    </center>
<table class="table table-bordered">
...
<tr>
    <td style="">
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('A3',lang('STAT_MAIN_num'));
                    echo lang('STAT_MAIN_num'); ?>
                </center>
            </small>
        </strong>
    </td>
    ...
    <td style="">
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('C3',lang('NEW_subj'));
                    echo lang('NEW_subj'); ?>
                </center>
            </small>
        </strong>
    ...
    <td style="">
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('D3',lang('t_LIST_create'));
                    echo lang('t_LIST_create'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td style="">
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('E3',lang('t_LIST_init'));
                    echo lang('t_LIST_init'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td style="">
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('F3',lang('t_LIST_to'));
                    echo lang('t_LIST_to'); ?>
                </center>
            </small>
        </strong>
    ...
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('G3',lang('USERS_p_4'));
                    echo lang('USERS_p_4'); ?>
                </center>
            </small>
        </strong>
    ...
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue('H3',lang('t_LIST_status'));
                    echo lang('t_LIST_status'); ?>
                </center>
            </small>
        </strong>
    </td>
                    ...
                    if (in_array($unit, $ec)) {
                        ...
                        if (!empty($re)) {
                            ...
                            foreach ($re as $row) {
                                ...
                                if ($row['to_user_id'] <> 0) {
                                    $to_text  = "<div class=''>" . nameshort(name_of_user_ret($row['to_user_id'])) . "</div>";
                                    $executor = name_of_client_ret($row['to_user_id']);
                                }
                                if ($row['to_user_id'] == 0) {
                                    $to_text  = view_array(get_unit_name_return($row['to_unit_id']));
                                    $executor = $to_text;
                                ...
                                if ($t_status == 1) {
                                    $st = "<span class=\"label label-success\"><i class=\"fa fa-check-circle\"></i> " . lang('t_list_a_oko') . " " . nameshort(name_of_user_ret_nolink($t_ob)) . "</span>";
                                    $t_ago  = get_date_ok($t_dc, $row['ticket_id']);
                                    $status = lang('t_list_a_oko');
                                }
                                if ($t_status == 0) {
                                    $t_ago = $t_dc;
                                    if ($t_lb <> 0) {
                                        $st = "<span class=\"label label-default\"><i class=\"fa fa-gavel\"></i> " . lang('t_list_a_lock_u') . " " . nameshort(name_of_user_ret_nolink($t_lb)) . "</span>";
                                        $status = lang('t_list_a_lock_u');
                                    }
                                    if ($t_lb == 0) {
                                        $st     = "<span class=\"label label-primary\"><i class=\"fa fa-clock-o\"></i> " . lang('t_list_a_hold') . "</span>";
                                        $status = lang('t_list_a_hold');
                                    }
                                }
...
?>
                                <tr>
                                    <td>
                                        <small>
                                            <center>
                                                <?php $sheet->setCellValue("A$counter",$i);
                                                echo $i; ?>
                                            </center>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <center>
                                                <?php $sheet->setCellValue("B$counter",$row['ticket_id']); echo $row['ticket_id']; ?>
                                            </center>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <a href="ticket?<?php echo get_ticket_hash_by_id($row['ticket_id']); ?>">
                                                <?php
                                                $sheet->setCellValue("C$counter",str_replace('"', "", make_html(strip_tags(get_ticket_val_by_hash('subj', get_ticket_hash_by_id($row['ticket_id']))) , 'no')));
                                                echo str_replace('"', "", make_html(strip_tags(get_ticket_val_by_hash('subj', get_ticket_hash_by_id($row['ticket_id']))) , 'no')); ?>
                                            </a>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <time id="c" datetime="<?php $sheet->setCellValue("D$counter",$row['date_op']); echo $row['date_op'] ?>"></time>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php $sheet->setCellValue("E$counter",name_of_client_ret($row['init_user_id'])); echo name_of_user_ret($row['init_user_id']); ?>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php $sheet->setCellValue("F$counter",$executor); echo $to_text; ?>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php
                                            $sheet->setCellValue("G$counter", name_of_client_ret(get_ticket_val_by_hash('client_id', get_ticket_hash_by_id($row['ticket_id']))));
                                            echo nameshort(name_of_user_ret(get_ticket_val_by_hash('client_id', get_ticket_hash_by_id($row['ticket_id'])))); ?>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php $sheet->setCellValue("H$counter",$status); echo $st; ?>
                                        </small>
                                    </td>
                                </tr>
                                <?php
...
<center>
    <h4>
        <?php
        $counter += 1;
        $sheet->setCellValue('A'.$counter,lang('STAT_MAIN_t2'));
        $sheet->mergeCells('A'.$counter.':H'.$counter);
        $counter += 1;
        echo lang('STAT_MAIN_t2');?>
    </h4>
</center>
<table class="table table-bordered">
<tbody><tr>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("A$counter",lang('STAT_MAIN_num')); echo lang('STAT_MAIN_num'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("B$counter",'#'); ?>
                    #
                </center>
            </small>
        </strong>
    ...
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("C$counter",lang('NEW_subj')); echo lang('NEW_subj'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("D$counter",lang('t_LIST_create')); echo lang('t_LIST_create'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("E$counter",lang('t_LIST_init')); echo lang('t_LIST_init'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("F$counter",lang('t_LIST_to')); echo lang('t_LIST_to'); ?>
                </center>
            </small>
        </strong>
    </td>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("G$counter",lang('USERS_p_4')); echo lang('USERS_p_4');?>
                </center>
            </small>
        </strong>
    </td>
    <td>
        <strong>
            <small>
                <center>
                    <?php $sheet->setCellValue("H$counter",lang('t_LIST_status')); echo lang('t_LIST_status'); ?>
                </center>
            </small>
        </strong>
    </td>
                    ...
                    if (in_array($unit, $ec)) {
                        ...
                        if (!empty($re)) {
                            ...
                            foreach ($re as $row) {
                                ...
                                if ($row['user_to_id'] <> 0) {
                                    $to_text  = "<div class=''>" . nameshort(name_of_user_ret($row['user_to_id'])) . "</div>";
                                    $executor = name_of_client_ret($row['user_to_id']);
                                }
                                if ($row['user_to_id'] == 0) {
                                    $to_text  = view_array(get_unit_name_return($row['unit_id']));
                                    $executor = $to_text;
                    ...
                    ?>
                                <tr>
                                    <td>
                                        <small>
                                            <center>
                                                <?php $sheet->setCellValue("A$counter",$i); echo $i; ?>
                                            </center>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <center>
                                                <?php $sheet->setCellValue("B$counter",$row['id']); echo $row['id']; ?>
                                            </center>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <a href="ticket?<?php echo get_ticket_hash_by_id($row['id']); ?>">
                                                <?php
                                                $sheet->setCellValue("C$counter",strip_tags(get_ticket_val_by_hash('subj', get_ticket_hash_by_id($row['id']))) , 'no');
                                                echo str_replace('"', "", make_html(strip_tags(get_ticket_val_by_hash('subj', get_ticket_hash_by_id($row['id']))) , 'no')); ?>
                                            </a>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            ...
                                            $sheet->setCellValue("D$counter",$row['ok_date']);
                                            echo $row['ok_date'] ?>"></time>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php
                                            $sheet->setCellValue("E$counter",name_of_client_ret($row['user_init_id']));
                                            echo name_of_user_ret($row['user_init_id']); ?>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php
                                            $sheet->setCellValue("F$counter",$executor);
                                            echo $to_text; ?>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php
                                            $sheet->setCellValue("G$counter",name_of_client_ret(get_ticket_val_by_hash('client_id', get_ticket_hash_by_id($row['id']))));
                                            echo nameshort(name_of_user_ret(get_ticket_val_by_hash('client_id', get_ticket_hash_by_id($row['id'])))); ?>
                                        </small>
                                    </td>
                                    <td>
                                        <small>
                                            <?php
                                            $sheet->setCellValue("H$counter",$status);
                                            echo $st; ?>
                                        </small>
                                    </td>
                                </tr>
...
<center>
    <h4>
        <?php
        $counter += 1;
        $sheet->setCellValue("A$counter",lang('STAT_MAIN_t3'));
        $sheet->mergeCells("A$counter:H$counter");
        $counter += 1;
        echo lang('STAT_MAIN_t3'); ?>
    </h4>
</center>
<table class="table table-bordered">
    <tr>
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("A$counter",lang('STAT_MAIN_num'));
                        echo lang('STAT_MAIN_num'); ?>
                    </center>
                </small>
            </strong>
        ...
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("C$counter",lang('NEW_subj'));
                        echo lang('NEW_subj'); ?>
                    </center>
                </small>
            </strong>
        ...
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("D$counter",lang('t_LIST_create'));
                        echo lang('t_LIST_create'); ?>
                    </center>
                </small>
            </strong>
        ...
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("E$counter",lang('t_LIST_init'));
                        echo lang('t_LIST_init'); ?>
                    </center>
                </small>
            </strong>
        ...
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("F$counter",lang('t_LIST_to'));
                        echo lang('t_LIST_to'); ?>
                    </center>
                </small>
            </strong>
        ...
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("G$counter",lang('USERS_p_4'));
                        echo lang('USERS_p_4'); ?>
                    </center>
                </small>
            </strong>
        ...
        <td>
            <strong>
                <small>
                    <center>
                        <?php
                        $sheet->setCellValue("H$counter",lang('t_LIST_status'));
                        echo lang('t_LIST_status'); ?>
                    </center>
                </small>
            </strong>
                        ...
                        <tr>
                            ...
                            <td>
                                <small>
                                    <center>
                                        <?php
                                        $sheet->setCellValue("B$counter",$row['id']);
                                        echo $row['id']; ?>
                                    </center>
                                </small>
                            </td>
                            <td>
                                <small>
                                    ...
                                    <?php $sheet->setCellValue("C$counter",strip_tags(get_ticket_val_by_hash('subj', get_ticket_hash_by_id($row['id'])))); ?>
                                </small>
                            </td>
                            <td>
                                <small>
                                    <time id="c" datetime="
                                    <?php
                                    $sheet->setCellValue("D$counter",$row['last_update']);
...
?>
        <div class="box box-solid">
            <div class="box-header">
                <h4 class="box-title"><?php
                    $counter += 1;
                    $sheet->setCellValue("A$counter",lang('ALLSTATS_main').' '.$start.' '.$end);
                    $sheet->mergeCells("A$counter:H$counter");
                    $counter += 1;
                echo lang('ALLSTATS_main'); ?> <time id="c" datetime="<?php
                echo $start ?>"></time> - <time id="c" datetime="<?php echo $end ?>"></time></h4>
</div>
            <div class="box-body">
            <h4>
                <center>
                    <?php
                    $sheet->setCellValue("A$counter",lang('ALLSTATS_unit'));
                    echo lang('ALLSTATS_unit'); ?>
                </center>
            </h4>
                    <table class="table table-bordered">
                    <tbody>
                        ...
                        <td>
                            <strong>
                                <small>
                                    <center>
                                        <?php
                                        $sheet->setCellValue("B$counter",lang('ALLSTATS_unit_out'));
                                        echo lang('ALLSTATS_unit_out'); ?>
                                    </center>
                                </small>
                            </strong>
                        </td>
                        <td>
                            <strong>
                                <small>
                                    <center>
                                        <?php
                                        $sheet->setCellValue("C$counter",lang('ALLSTATS_unit_free'));
                        ...
                        <td>
                            <strong>
                                <small>
                                    <center>
                                        <?php
                                        $sheet->setCellValue("D$counter",lang('ALLSTATS_unit_lock'));
                        ...
                        <td>
                            <strong>
                                <small>
                                    <center>
                                        <?php
                                        $sheet->setCellValue("E$counter",lang('ALLSTATS_unit_ok'));
                ...
                <tr>
                    <td>
                        <small>
                            <?php
                            $sheet->setCellValue("A$counter",get_unit_name_return4news($value));
                    ...
                    <td>
                        <small>
                            <center><?php
                                $sheet->setCellValue("B$counter",get_unit_stat_create($value, $start, $end));
                                echo get_unit_stat_create($value, $start, $end); ?>
                            </center>
                        </small>
                    </td>
                    <td>
                        <small>
                            <center><?php
                                $sheet->setCellValue("C$counter",get_unit_stat_free($value, $start, $end));
                                echo get_unit_stat_free($value, $start, $end); ?>
                            </center>
                        </small>
                    </td>
                    <td>
                        <small>
                            <center><?php
                                $sheet->setCellValue("D$counter",get_unit_stat_lock($value, $start, $end));
                                echo get_unit_stat_lock($value, $start, $end); ?>
                            </center>
                        </small>
                    </td>
                    <td>
                        <small>
                            <center><?php
                                $sheet->setCellValue("E$counter",get_unit_stat_ok($value, $start, $end));
                                echo get_unit_stat_ok($value, $start, $end); ?>
                            </center>
                        </small>
                    </td>
                </tr>
    <?php
        ...
        <h4>
            <center><?php
                    $counter += 1;
                    $sheet->setCellValue("A$counter",lang('ALLSTATS_user'));
                    $sheet->mergeCells("A$counter:H$counter");
                    echo lang('ALLSTATS_user');
                    $counter += 1;
                ?>
            </center>
        </h4>
                    ...
                    <td style="width: 200px;">
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("A$counter",lang('ALLSTATS_user_fio'));
                                    echo lang('ALLSTATS_user_fio'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("B$counter",lang('t_LIST_status'));
                                    echo lang('t_LIST_status'); ?>
                                </center>
                            </small>
                        </strong>
                    ...
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("C$counter",lang('EXT_t_created'));
                                    echo lang('EXT_t_created'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("D$counter",lang('EXT_stats_refer'));
                                    echo lang('EXT_stats_refer'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("E$counter",lang('EXT_t_oked'));
                                    echo lang('EXT_t_oked'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("F$counter",lang('EXT_stats_lock'));
                                    echo lang('EXT_stats_lock'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("G$counter",lang('EXT_stats_unlock'));
                                    echo lang('EXT_stats_unlock'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <small>
                                <center>
                                    <?php
                                    $sheet->setCellValue("H$counter",lang('EXT_stats_no_ok'));
                                    echo lang('EXT_stats_no_ok'); ?>
                                </center>
                            </small>
                        </strong>
                    </td>
...
<tr>
                    <td style="width: 200px;">
                        <small>
                            <?php
                            $sheet->setCellValue("A$counter",name_of_client_ret($row['id']));
                    ...
                    <td>
                        <small class="text-danger">
                            <center>
                                <?php
                                $sheet->setCellValue("B$counter",get_user_status_text($row['id']));
                    ...
                    <td>
                        <small class="text-danger">
                            <center>
                                <?php
                                $sheet->setCellValue("C$counter",$get_total_tickets_create);
                                echo $get_total_tickets_create; ?>
                            </center>
                        </small>
                    </td>
                    <td>
                        <small class="text-warning">
                            <center>
                                <?php
                                $sheet->setCellValue("D$counter",$get_total_tickets_refer);
                                echo $get_total_tickets_refer; ?>
                            </center>
                        </small>
                    </td>
                    <td>
                        <small class="text-success">
                            <center><?php
                                $sheet->setCellValue("E$counter",$get_total_tickets_ok);
                    ...
                    <td>
                        <small class="">
                            <center>
                                <?php
                                $sheet->setCellValue("F$counter",$get_total_tickets_lock);
                    ...
                    <td>
                        <small class="">
                            <center>
                                <?php
                                $sheet->setCellValue("G$counter",$get_total_tickets_unlock);
                                echo $get_total_tickets_unlock; ?>
                            </center>
                        </small>
                    </td>
                    <td>
                        <small class="">
                            <center>
                                <?php
                                $sheet->setCellValue("H$counter",$get_total_tickets_no_ok);
                                echo $get_total_tickets_no_ok; ?>
                            </center>
                        </small>
                    </td>
</tr>
...
<?php
                        ...
                        <div class="box box-info">
                            <div class="box-header">
                                <h4 class="box-title">
                                    ...
                                    $sheet->setCellValue("A1",lang('EXT_stat_title').' '.$start.' '.$end);
                                    $sheet->mergeCells('A1:C1');

                                    echo lang('EXT_stat_title'); ?>
                                    <time id="c" datetime="<?php echo $start ?>"></time> - <time id="c" datetime="<?php echo $end ?>"></time>
                                </h4>
                            </div>
                                    ...
                                    <tr>
                                        <th>
                                            <center>
                                                <small>
                                                    <?php
                                                    $sheet->setCellValue('A2',lang('TICKET_t_date'));
                                        ...
                                        <th>
                                            <center>
                                                <small>
                                                    <?php
                                                    $sheet->setCellValue('B2',lang('TICKET_name'));
                                        ...
                                        <th>
                                            <center>
                                                <small>
                                                    <?php
                                                    $sheet->setCellValue('C2',lang('TICKET_t_desc'));
                                    ...
                                    foreach ($re as $row) {
                                        ...
                                        <tr>
                                            <td style="width: 100px; vertical-align: inherit;">
                                                <small>
                                                    <center>
                                                        <?php $sheet->setCellValue("A$i",$row['date_op']); ?>
                                                        <time id="c" datetime="<?php echo $row['date_op'] ?>"></time>
                                                    </center>
                                                </small>
                                            </td>
                                            <td style=" width: 70px; vertical-align: inherit;">
                                                <center>
                                                    <small>
                                                        <?php $sheet->setCellValue("B$i",$row['ticket_id']); ?>
                                                        <a href="ticket?<?php echo get_ticket_hash_by_id($row['ticket_id']) ?>"> #<?php
                                                            echo $row['ticket_id'] ?>
                                                        </a>
                                                    </small>
                                                </center>
                                            ...
                                            <td style=" width: 50px; vertical-align: inherit;">
                                                <small>
                                                    <center>
                                                        <i class="<?php echo $icon_action; ?>"></i>
                                                    </center>
                                                </small>
                                            </td>
                                            <td style=" width: 200px; vertical-align: inherit;">
                                                <small><?php
                                                    $sheet->setCellValue("C$i",$text_action);
                                                    echo $text_action ?></small>
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
                        ...
                        <div class="box box-info">
                            <div class="box-header">
                                <h4 class="box-title">
                                    <?php
                                    $i += 1;
                                    $sheet->setCellValue("A$i",lang('EXT_stats_main'));
                                    $sheet->mergeCells("A$i:F$i");
                                    $i += 1;
                                    echo lang('EXT_stats_main'); ?>
                                </h4>
                            </div>
                            <?php
                            $sheet->setCellValue("A$i",lang('EXT_t_created'));
                            $sheet->setCellValue("B$i",lang('EXT_stats_refer'));
                            $sheet->setCellValue("C$i",lang('EXT_t_oked'));
                            $sheet->setCellValue("D$i",lang('EXT_stats_lock'));
                            $sheet->setCellValue("E$i",lang('EXT_stats_unlock'));
                            $sheet->setCellValue("F$i",lang('EXT_stats_no_ok'));
                            $i += 1;
                            $sheet->setCellValue("A$i",$get_total_tickets_create);
                            $sheet->setCellValue("B$i",$get_total_tickets_refer);
                            $sheet->setCellValue("C$i",$get_total_tickets_ok);
                            $sheet->setCellValue("D$i",$get_total_tickets_lock);
                            $sheet->setCellValue("E$i",$get_total_tickets_unlock);
                            $sheet->setCellValue("F$i",$get_total_tickets_no_ok);
                            ?>
                            <div class="row">
                                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                                    <input type="text" class="knob" data-readonly="true" value="<?php echo $get_total_tickets_create; ?>" data-width="100" data-height="100" data-max="50" data-max="<?php
                                ...
                                <div class="col-xs-4 text-center">
                                    <input type="text" class="knob" data-readonly="true" value="<?php echo $get_total_tickets_ok; ?>" data-width="100" data-height="100" data-max="50" data-max="<?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                                    <input type="text" class="knob" data-readonly="true" value="<?php echo $get_total_tickets_lock; ?>" data-width="100" data-height="100" data-max="50" data-max="<?php
  ...
  " . lang('TICKET_error_msg') . "
        ...
        if ($mode === 'getEventsReport') {
            try {
                if ($_POST) {
                    ...
                    $array['start']      = $_POST['start'].' 00:00:00';
                    $array['end']        = $_POST['end'].' 23:59:00';

                    if (!$_POST['sort'] && !$_POST['col']) {
                        $sort = $Events->checkSort();
                        if (!$sort) {
                            $array['sort'] = 'ASC';
                            $array['col']  = 'last_update';
                        } else {
                            $array['sort'] = 'ASC';
                            $array['col']  = 'last_update';
                        }
                    } else {
                        $array['sort'] = $_POST['sort'];
                        $array['col']  = $_POST['col'];
                    }

                    if ($array['uid'] >= 0 || $array['department'] >= 0) {
                        $response = $Events->displayReport($array);
                    } else {
                        $response = false;
                    }
                }
        ...
        if ($mode === 'get_users_by_dep') {
            ...
            $Events = new EventsReport($CONF_HD['xls_report_path']);
            if ($department > 0) {
                $users = $Events->getUsersByDepartment($department);
            } else {
        ...
        if ($mode == "dashboard_t") {
            ...
            if ($priv_val == 0) {
                ...
                $stmt = $dbConnection->prepare('SELECT * FROM tickets
                            WHERE unit_id IN (' . $in_query . ') AND arch=:n AND status <> 3
                ...
                $stmt = $dbConnection->prepare('SELECT * from tickets
                            where ((find_in_set(:user_id,user_to_id) and arch=:n AND status <> 3) or
                            (find_in_set(:n1,user_to_id) and unit_id IN (' . $in_query . ') AND arch=:n2 AND status <> 3))
                            order by ok_by asc, prio desc, id desc
                            limit :start_pos, :perpage');
...
?>
                ...
                <th><center><div id="sort_subj"><?php
                echo lang('t_LIST_placer'); ?><?php
                echo $subj_icon; ?></div></center></th>
				<th><center><div id="sort_subj"><?php
                echo lang('t_LIST_txtmg'); ?><?php
                echo $subj_icon; ?></div></center></th>
				<th><center><?php
                echo lang('t_LIST_commen'); ?></center></th>
				<th><center><?php
                echo lang('t_LIST_to'); ?></center></th>
				<th><center><div id="sort_subj"><?php
                echo lang('t_LIST_compl'); ?><?php
                echo $subj_icon; ?></div></center></th>
					<th><center><?php
                echo lang('t_LIST_zatr'); ?></center></th>
...
?></center></small></td>
                    ...
                    <center><?php
                    cutstr(make_html($row['subj'], 'no')); ?></center></small></td>
                    ...
                    echo get_user_val_by_id($row['client_id'], 'fio'); ?>
                        ...
                        <td style=" vertical-align: middle; "><small class="<?php
                    echo $muclass; ?>"><center><?php
                    echo $row['date_create']; ?></center></small></td>
                    <td style=" vertical-align: middle; "><small class="<?php
                    echo $muclass; ?>">
					<center>
                    <?php
                    echo $row['sabj_pl']?>
						...
						<td style=" vertical-align: middle; "><small><a class="<?php
                    echo $muclass; ?>  
                    title="<?php
                    ?>"
                    data-content="<small><?php
                    ...
                    <time id="f" datetime="<?php echo $t_ago; ?>"></time>
<?php
...
?>
        ...
        /**
         * updated 27-02-2019 19:28 by arava (email: newbie.jedicoder@gmail.com )
         * Ticket filtering by types: assign me, personal, free etc...
         */
        if ($mode == "sort_list") {
            $pt = $_POST['pt']; // filter type IN or OUT
            $sort_type = $_POST['st']; // button value (personal, free, ...)
            ...
            if ($pt == "in") {
                switch ($sort_type) {
                    ...
                    case 'lock':
                        ...
                        break;
                    case 'personal':
                        $_SESSION['hd.rustem_sort_in'] = 'personal';
                        break;
                    case 'no_long_term': // filter ticket list with or without long_term type
                        if ($_SESSION['hd.no_display']) {
                            unset($_SESSION['hd.no_display']);
                        } else {
                            $_SESSION['hd.no_display'] = 'no_long_term';
                        }
                        break;
                    case 'activity_24_hours':
                        $_SESSION['hd.rustem_sort_in'] = 'activity_24_hours';
                        break;
                    default:
                        unset($_SESSION['hd.rustem_sort_in']);
                }
                ...
                switch ($sort_type) {
                    ...
                    case 'lock':
                        ...
                        break;
                    case 'personal':
                        $_SESSION['hd.rustem_sort_out'] = 'personal';
                        break;
                    case 'no_long_term': // filter ticket list with or without long_term type
                        if ($_SESSION['hd.no_display']) {
                            unset($_SESSION['hd.no_display']);
                        ...
                        break;
                    case 'activity_24_hours':
                        $_SESSION['hd.rustem_sort_out'] = 'activity_24_hours';
                        break;
                    default:
                        unset($_SESSION['hd.rustem_sort_out']);
                }
        ...
        if ($mode === 'events_sort') {
            ...
            $Events = new EventsReport($CONF_HD['xls_report_path']);
            $sort   = $Events->getSort($column);

            if ($sort && $sort['sort'] === 'DESC') {
                $Events->setSort($column,'ASC');
                $sort = 'ASC';
            } else {
                $Events->setSort($column,'DESC');
                $sort = 'DESC';
            }
...
VALUES (:fio, :login, :tel, :adr, :email, :posada,:skype,:type_op, :user_from, :cid,  :n)');
        ...
        /**
         * Mark ticket as canceled (update by arava:02/03/2019 11:00) newbie.jedicoder@gmail.com
         * cancel == ticket status number 3 in the table
         */
        if ($mode === 'ticket_cancel') {
            $user = ($_POST['user']);
            $idt  = ($_POST['tid']);
...
values (:edit_subj, :n, :unow, :pk)');
			...
			if ($sabj_pl != $fio['sabj_pl']) {
                
                $stmt = $dbConnection->prepare('update tickets set sabj_pl=:sabj_pl, last_edit=:n, last_update=:nz where hash_name=:pk');
                $stmt->execute(array(
                    ':sabj_pl' => $sabj_pl,
                    ':pk' => $t_hash,
                    ':n' => $CONF['now_dt'],
...
?>
      ...
      where uniq_hash=:id');
        ...
        if ($mode == "add_ticket") {
			...
			$sabj_pl = strip_tags(xss_clean(($_POST['sabj_pl'])));
            $status = '0';
            $unit_id = ($_POST['unit_id']);
            $prio = ($_POST['prio']);
            $corpus_id = $_POST['corpus_id'];
            $room_numb = $_POST['room_numb'];
            ...
            */
            ...
            if ($type == "add") {
             ...
             :api_key)');
                ...
                $stmt = $dbConnection->prepare('INSERT INTO tickets
                                (id, user_init_id,user_to_id,date_create,subj,sabj_pl,msg, client_id, unit_id, status, hash_name, prio, last_update, deadline_time, sla_plan_id, corpus_id, room_numb) VALUES (:max_id_res_ticket, :user_init_id, :user_to_id, :n,:subj, :sabj_pl,:msg,:max_id,:unit_id, :status, :hashname, :prio, :nz, :deadline_time, :sla_plan_id, :corpus_id, :room_numb)');
                $stmt->execute(array(
                    ...
                    ':corpus_id' => $corpus_id == 'undefined' || !$corpus_id ? 0 : $corpus_id,
                    ':room_numb' => $room_numb == 'undefined' || !$room_numb ? 0 : $room_numb,
                ));
                
				//send_sms_to_managers($unit_id, $max_id_res_ticket);
            ...
            if ($type == "client") {
                ...
                $stmt = $dbConnection->prepare('INSERT INTO tickets
                                (id, user_init_id,user_to_id,date_create,subj,sabj_pl,msg, client_id, unit_id, status, hash_name, prio, last_update,deadline_time, sla_plan_id) VALUES (:max_id_res_ticket, :user_init_id, :user_to_id, :n,:subj,:sabj_pl, :msg,:max_id,:unit_id, :status, :hashname, :prio, :nz, :deadline_time, :sla_plan_id)');
        ...
        /**
         * Get types by department
         * @param $dname
         * @return array
         */
        if ($mode === 'get_ticket_type') {
            $dname = $_POST['dname'];
            if ($dname) {
                GLOBAL $dbConnection;
                $stmt = $dbConnection->prepare(
                    'SELECT types AS name FROM deps_types WHERE dname = :dname LIMIT 1'
                );
                $prepared = array(':dname' => $dname,);
                $stmt->execute($prepared);
                $data = $stmt->fetchAll();
                if ($data) {
                    $data = explode(',',$data[0]['name']);
                    ...
                    if ($data) {
                        ...
                        echo json_encode('No types in the system');
                    }
                }
                exit;
            }

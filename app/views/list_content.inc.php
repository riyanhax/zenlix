...
<?php
    ...
    a.id, a.user_init_id, a.user_to_id, a.date_create, a.subj, a.subj_pl, a.msg, a.client_id, a.unit_id, a.status, a.hash_name, 
        ...
        if ($priv_val == 0) {
            ...
            */
            ...
            if (isset($_SESSION['hd.rustem_sort_in'])) {
                ...
                else if ($_SESSION['hd.rustem_sort_in'] == "personal") {
                    $stmt = $dbConnection->prepare('SELECT * FROM tickets
                            WHERE arch=:n AND status = :null AND user_to_id = :uid
    ...
    if ($_POST['menu'] == 'arch') {
        ...
        if ($priv_val == 0) {
            ...
            $stmt = $dbConnection->prepare('SELECT 
                            id, user_init_id, user_to_id, date_create, subj, sabj_pl, msg, client_id, unit_id, status, hash_name, is_read, lock_by, ok_by, ok_date
                            from tickets

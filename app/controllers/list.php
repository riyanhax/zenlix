...
if (validate_user($_SESSION['helpdesk_user_id'], $_SESSION['code'])) {
    ...
    if (isset($_GET['in'])) {
        ...
        $_POST['page'] = "1";
        try {
            require_once  ("list_content.inc.php");
        } catch (Exception $e) {
            echo $e->getMessage();
        }
        ...
        if (isset($_SESSION['hd.rustem_sort_in'])) {
            switch ($_SESSION['hd.rustem_sort_in']) {
                ...
                case 'lock':
                    ...
                    break;
                case 'personal':
                    $button_sort_in['personal'] = 'active';
                    break;
                default:
    ...
    try {
        ...
        echo $template->render(array(
            ...
            'button_sort_out_personal' => $button_sort_out['personal'],
            'nn' => $nn,
            'menu' => $_POST['menu'],
            'r' => $r, // sort in or out
            ...
            'with_long_term' => lang('with_long_term'),
            'without_long_term' => lang('without_long_term'),
            'tasks_24_hours' => lang('tasks_24_hours'),
        ));
    }
    catch(Exception $e) {
